          ...
          <div key={item.name}>
            <Link
              ...
              className={`
                ...
                ${isActive(item.href) 
                  ? 'bg-primary-100 dark:bg-primary-900/20 text-primary-700 dark:text-primary-400 border border-primary-200 dark:border-primary-800' 
            ...
            >
              <item.icon 
                size={20} 
                className={`mr-3 ${isActive(item.href) ? 'text-primary-500 dark:text-primary-400' : 'text-gray-400 dark:text-gray-500'}`}
              />
