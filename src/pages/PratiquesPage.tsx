...
import { Shield, AlertCircle, GitBranch, Zap, Package, Users, Settings, FileText, TrendingUp, CheckCircle, Activity, Database, Wrench } from 'lucide-react'
            ...
            <div className="p-5">
              <div className="flex items-start justify-between">
                ...
                <div className={`transform transition-transform ${
                  selectedPratique === pratique.id ? 'rotate-180' : ''
                }`}>
