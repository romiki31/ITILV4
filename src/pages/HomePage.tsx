    ...
    <div className="max-w-6xl mx-auto space-y-12">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h3 className="font-semibold text-yellow-900 mb-2">Avant de commencer</h3>
          ...
          {learningPaths.map((path) => (
            ...
            >
              ...
              <div className="mb-4">
                ...
                <span className="text-sm font-medium text-gray-700 ml-2">{path.duration}</span>
              </div>
          ...
          <dl className="space-y-3">
            {Object.entries(examInfo).map(([key, value]) => (
              <div key={key} className="flex justify-between">
                <dt className="text-blue-700 capitalize">{key.replace(/([A-Z])/g, ' $1').trim()} :</dt>
          ...
          <div className="space-y-2">
            {keyTopics.map((topic) => (
              <div key={topic.name} className="flex items-center justify-between">
                <span className="text-green-700">{topic.name}</span>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-green-900 w-12 text-right">
                    {topic.questions}Q
                  </span>
                </div>
              </div>
      ...
      <section>
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Explorez les sections</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link to="/fondamentaux" className="card card-hover flex items-center space-x-4">
            <BookOpen className="h-8 w-8 text-blue-500" />
            <div>
              <h4 className="font-semibold text-gray-900">Fondamentaux</h4>
              <p className="text-sm text-gray-600">Concepts, principes et dimensions</p>
            </div>
          </Link>
          ...
          <Link to="/svs" className="card card-hover flex items-center space-x-4">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">SVS & CVS</h4>
              <p className="text-sm text-gray-600">Système et chaîne de valeur</p>
            </div>
          </Link>
          ...
          <Link to="/pratiques" className="card card-hover flex items-center space-x-4">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">15 Pratiques</h4>
              <p className="text-sm text-gray-600">Pratiques du syllabus Foundation</p>
            </div>
          </Link>
          ...
          <Link to="/etudes-cas" className="card card-hover flex items-center space-x-4">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">Études de cas</h4>
              <p className="text-sm text-gray-600">Cas pratiques détaillés</p>
            </div>
          </Link>
          ...
          <Link to="/quiz" className="card card-hover flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">100+ questions d'examen</p>
            </div>
          </Link>
          ...
          <Link to="/examen" className="card card-hover flex items-center space-x-4">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">Conseils Examen</h4>
              <p className="text-sm text-gray-600">Stratégies et pièges</p>
            </div>
          </Link>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-primary-50 to-purple-50 rounded-lg p-8 border border-primary-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-3">
            <div className="flex items-start">
              ...
              <div>
                <p className="font-medium text-gray-900">Maîtrisez les distinctions</p>
                <p className="text-sm text-gray-600">Incident vs Problème, SLA vs OLA, Output vs Outcome</p>
              </div>
            </div>
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-primary-600 mr-3 mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-medium text-gray-900">Attention aux absolus</p>
                <p className="text-sm text-gray-600">TOUJOURS, JAMAIS, TOUS = souvent des pièges</p>
              </div>
            </div>
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-primary-600 mr-3 mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-medium text-gray-900">La valeur est co-créée</p>
                <p className="text-sm text-gray-600">Jamais créée unilatéralement par le fournisseur</p>
              </div>
            </div>
          </div>
          <div className="space-y-3">
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-primary-600 mr-3 mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-medium text-gray-900">CVS flexible</p>
                <p className="text-sm text-gray-600">Pas d'ordre fixe, sauf Améliorer toujours présente</p>
              </div>
            </div>
            <div className="flex items-start">
              <CheckCircle className="h-5 w-5 text-primary-600 mr-3 mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-medium text-gray-900">CAB = Advisory</p>
                <p className="text-sm text-gray-600">Conseille mais n'approuve pas les changements</p>
              </div>
            </div>
          </div>
        </div>
